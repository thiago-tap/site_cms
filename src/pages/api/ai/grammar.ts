  ...
  try {
    ...
    const res = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        model: 'gpt-4o-mini',
        messages: [
          { role: 'system', content: 'Você é um revisor de texto em português brasileiro. Revise o texto a seguir corrigindo erros gramaticais, ortográficos e de pontuação. Retorne APENAS o texto corrigido, sem comentários.' },
